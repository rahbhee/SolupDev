      ...
      <ul className='mt-16 ml-2 md:ml-0 space-y-6' >
        {
          SIDEBAR_LINKS.map((link, index) => (
            <li key={link.id} onClick={() => setActiveLink()} className='sidebar-item text-gray-500 font-medium md:space-x-5 justify-between text-sm rounded-2xl py-2 px-5 hover'>
