...
const PortfolioAll = ({handleAllClick}) => {
  ...
  return (
    <div className='flex flex-col gap-2'>
      ...
      <div className='text-xs bonkmom grid md:gap-4 grid-cols-7 bg-white '>
  <div className='py-6 col-span-2 flex side px-6 relative'>
    <h4 className='bg-purple-600 w-24 text-white text-center absolute top-0 left-0 bonkpro py-1'>Project</h4>
    <h1 className='font-semibold text-lg flex mt-4 items-center justify-center bonk'>BonkMom</h1>
  </div>
  <div className='side items-center col-span-1 flex justify-center py-3 md:py-6 px-6'>
    <h3 className='px-4'>400,00</h3>
  </div>
  ...
  <div className='py-3 items-center col-span-1 flex justify-center md:py-6 px-6'>
    <h3 className='px-2 py-1 perc'>+2.0%</h3>
  </div>
  </div>
   <div className='text-xs bonkmom grid md:gap-4 grid-cols-7 bg-white '>
  <div className='py-6 col-span-2 flex side px-6 relative'>
